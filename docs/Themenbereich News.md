...
News schaffen Transparenz und Orientierung.

Mitarbeitende verstehen:

- was aktuell wichtig ist,
- welche Veränderungen stattfinden,
- woran Teams arbeiten,
- welche neuen Funktionen in yonesty verfügbar sind.

## Unterstützung durch Yona

Auch Yona nutzt die Informationen aus den News als zusätzlichen Kontext.

Dadurch kann Yona besser einordnen:

- welche Themen aktuell relevant sind,
- welche Veränderungen in der Organisation stattfinden,
- welche neuen Funktionen in yonesty zur Verfügung stehen.

Je besser die News gepflegt werden, desto aktueller und hilfreicher können Informationen innerhalb der Organisation bereitgestellt werden.
