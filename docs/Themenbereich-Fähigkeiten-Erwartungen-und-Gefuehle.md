...
3. Vergib einen verständlichen Namen und beschreibe kurz, was mit der Fähigkeit gemeint ist.
4. Ordne die Fähigkeit passenden Rollen, Personen oder Entwicklungsbereichen zu.
5. Pflege bei Bedarf Skill-Level, Erwartung oder Bewertungslogik.
6. Ergänze Erwartungen, wenn klar beschrieben werden soll, was in einer Rolle benötigt wird.
