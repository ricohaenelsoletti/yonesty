...
## Das übergeordnete Ziel der Verbindung von Rollen und Prozessen
Das Ziel ist letztlich eine selbstorganisierte, resiliente und effiziente Organisation, in der:

* jede/r weiß, was von ihm/ihr erwartet wird,
* Verantwortung klar verteilt ist,
* Wissen nicht in einzelnen Köpfen „verschwindet",
* und die Organisation handlungsfähig bleibt, auch wenn sich Personen ändern.

## Probier es aus

In der Hammer und Nagel GmbH (Demo) zeigen wir Dir, wie diese Verbindungen aktuell aussehen. Du kannst zum Beispiel:

* Die  bestehenden Rollen und Prozesse anzeigen,
* die RACI-Zuordnungen (wer ist wofür verantwortlich) auswerten,
* oder analysieren, welche Prozesse eventuell noch keiner Rolle zugeordnet sind.
