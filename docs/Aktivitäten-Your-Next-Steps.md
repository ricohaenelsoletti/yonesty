...
Eine Aktivitätsvorlage kann zum Beispiel ein „Englischkurs A1“ vom Anbieter „Berlitz“ mit konkretem Datum sein. Im Rahmen eines Feedbackgesprächs kann diese Vorlage ausgewählt und einer Person als konkrete Aktivität zugewiesen werden. Dadurch wird aus einem allgemeinen Entwicklungswunsch eine klare, planbare Maßnahme.

Der Katalog ist wie ein Blumenstrauß an Möglichkeiten: Mitarbeitende und Führungskräfte können im Feedbackgespräch passende einzelne Blumen auswählen. Wenn wichtige Angebote fehlen, müssen sie zuerst als neue Aktivitätsvorlagen in den Katalog aufgenommen werden. So schafft yonesty nicht nur Transparenz über bestehende Entwicklungsmöglichkeiten, sondern macht sichtbar, wo neue Angebote entstehen sollten.
...
|---|---|---|
| Lesen / nutzen | Anwender, Teamleiter, Manager, HR Manager, Administrator | Eigene oder relevante Aktivitäten ansehen und verstehen. |
| Anlegen | Teamleiter, HR Manager, Anwender, Administrator | Neue Aktivitäten direkt oder aus Feedback heraus erstellen. |
| Ändern / Pflegen | Verantwortliche Person, Teamleiter, HR Manager | Beschreibung, Verantwortliche, Fälligkeit, Status und Verknüpfungen aktualisieren. |
| Löschen / Deaktivieren | Administrator oder berechtigte Verantwortliche | Nur wenn die Aktivität nicht mehr benötigt wird. |
| Aktivitätsvorlagen pflegen | HR Manager, Administrator | Vorlagen für wiederkehrende Entwicklungs- und Weiterbildungsaktivitäten pflegen. |
...
3. Beschreibe in der Vorlage, welche Art von Aufgabe, Entwicklungsschritt, Weiterbildung oder Maßnahme gemeint ist.
4. Ergänze bei Bedarf Anbieter, Termin, Zeitraum, Zielgruppe, Fähigkeiten, Rollen oder weitere Bezüge.
5. Speichere die Vorlage und stelle sicher, dass sie für berechtigte Personen im Feedbackprozess nutzbar ist.
